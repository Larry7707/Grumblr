...
urlpatterns = [
    ...
    url(r'^get_comment/(?P<id>\d+)$', views1.get_comment),
    ...
    url(r'^get_following/?$', views1.get_following),
    url(r'^get_following/(?P<time>.+)$', views1.get_following),
    url(r'^get_profile_stream/(?P<id>\d+)/?$', views1.get_profile_stream),
    url(r'^get_profile_stream/(?P<id>\d+)/(?P<time>.+)$', views1.get_profile_stream),
]